...
For more images of the Develo Box check out the page on **Generation MSX**:
[Tokuma Shoten Intermedia - DEVELOでべろBOX - Generation MSX](https://www.generation-msx.nl/hardware/tokuma-shoten-intermedia/develobox/media/1708/)
