...
{% include_cached link-to-other-post.html post="/official-pokemon-mini-sdk" description="For an introduction to the official SDK used to create Pokemon Mini games check out this post." %}
