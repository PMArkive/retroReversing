...
{% include_cached link-to-other-post.html post="/n64rdp" description="For more information about the second half of the RCP known as the Reality Display Processor check out this post." %}
...
{% include_cached link-to-other-post.html post="/ps1" description="For more information about Sony's answer to the Geometry calculation problem known as the GTE check out this post." %}
