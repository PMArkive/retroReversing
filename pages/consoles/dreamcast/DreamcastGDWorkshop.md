...
{% include_cached link-to-other-post.html post="/Sega-Dreamcast-Katana-Development-Kit" description="You can find out about the System Disc 2 in this main katana development kit post." %}
