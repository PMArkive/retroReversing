...
---
{% include_cached link-to-other-post.html post="/game-boy-advance-development-kit/" description="Since you have got this far you might be interested in Nintendo's previous generation of handheld development hardware, if so check out this post." %}
